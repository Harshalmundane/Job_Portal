  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        <Badge className={'text-blue-700 font-bold'} variant="ghost">postion Positions</Badge>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Location: <span className='pl-4 font-normal text-gray-800'>Nagpur</span></h1>
                <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>Full Type</span></h1>
                ...
                <h1 className='font-bold my-1'>Total Applicants: <span className='pl-4 font-normal text-gray-800'>singleJob</span></h1>
